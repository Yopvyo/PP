    ...
    void Graph:: ajouter()
{
    if(mouse_b&2)
    {
        ...
        cin>> p_sommet;
        //cout<<"Saisir la position x de votre sommet: "<<endl;
        //cin>>posx;
        //cout<<"Saisir la position y de votre sommet: "<<endl;
        //cin>>posx;
...
void Graph::sauvegarde(string nom_fichier)
{
    ...
    if(fic)
    {
        ...
        {
            pos_sommet1=el.second.m_interface ->m_top_box.get_posx()+2;
            pos_sommet2=el.second.m_interface->m_top_box.get_posy()+2;
            numero=to_string(el.first+1);

            fic<<el.first<<" "<< el.second.m_value<<" "<<pos_sommet1<<" "<<pos_sommet2<<" "<<nom_fichier+numero+".jpg"<<endl;
